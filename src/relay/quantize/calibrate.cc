...
Expr CreateSoftmaxCollector(const Expr& expr) { return SoftmaxCollector().Collect(expr); }
...
TVM_REGISTER_GLOBAL("relay._quantize.CreateSoftmaxCollector").set_body_typed(CreateSoftmaxCollector);
